...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    ...
    loaded = true,
    path = "/home/robin/.local/share/nvim/site/pack/packer/start/alpha-nvim",
    url = "https://github.com/goolord/alpha-nvim"
  },
  ["awesome-vim-colorschemes"] = {
    loaded = true,
    path = "/home/robin/.local/share/nvim/site/pack/packer/start/awesome-vim-colorschemes",
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/robin/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  nerdcommenter = {
    loaded = true,
    path = "/home/robin/.local/share/nvim/site/pack/packer/start/nerdcommenter",
  ...
  tagbar = {
    loaded = true,
    path = "/home/robin/.local/share/nvim/site/pack/packer/start/tagbar",
  ...
  ["vim-devicons"] = {
    loaded = true,
    path = "/home/robin/.local/share/nvim/site/pack/packer/start/vim-devicons",
  ...
  ["vim-multiple-cursors"] = {
    loaded = true,
    path = "/home/robin/.local/share/nvim/site/pack/packer/start/vim-multiple-cursors",
  ...
  ["vim-terminal"] = {
    loaded = true,
    path = "/home/robin/.local/share/nvim/site/pack/packer/start/vim-terminal",
